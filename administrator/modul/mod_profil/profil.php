...
switch ($_GET['act']){
  ...
  default:
    ...
    echo "<h2>Profil Web</h2>
          <form method=POST enctype='multipart/form-data' action=$aksi?module=profil&act=update>
          <input type=hidden name=id value=$r[id_modul]>
          <table>
          <tr><td>Nama Web</td><td> : <input type=text name='nama_web' value='$r[nama_web]' size=50></td></tr>
          ...
          <tr><td>Gambar</td><td> : <img src=../administrator/images/images_login/img_login_user.png></td></tr>
         <tr><td>Ganti Foto</td><td> : <input type=file size=30 name=fupload></td></tr>
         <tr><td>Isi Profil Web</td><td><textarea name='isi' style='width: 560px; height: 250px;'>$r[static_content]</textarea></td></tr>

...
switch($_GET['act']){
  // Tampil YM
  default:
    echo "<h2>YM Status Module by ASPKAA</h2>
    ...
    $tam=mysql_query("SELECT * FROM mod_ym ORDER BY id_ym");
    $no=1;
    ...
    echo "</table>";
  echo "<hr><h5> Modul YM LearningHTML powered by <a href='#'>KamalASP</a> </h5>";
    break;
